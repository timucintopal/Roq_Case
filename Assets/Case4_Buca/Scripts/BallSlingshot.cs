...
namespace Case4_Buca.Scripts
{
    ...
    public class BallSlingshot : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            {
                MInput.Instance.OnPointerDownEvent += HandlePointerDown;
                MInput.Instance.OnPointerDragEvent += HandlePointerDrag;
                MInput.Instance.OnPointerUpEvent += HandlePointerUp;
            }
        }
        ...
        {
            if (MDisk.Instance != null)
            {
                rb.Sleep(); 
                transform.position = MDisk.Instance.transform.position;
